...
<head>
	...
	<title>Painel de Consulta Dividas</title>
...
<body>
	<div class="container">
		...
		<h2>Consulta Dividas</h2>
		<input type="text" id="dividas" placeholder="Digite o CPF/CNPJ">
		<button id="consultarBtn" onclick="consultarDividas()" disabled>Consultar</button>
	...
	<script src="../../assets/js/consultas/consulta_dividas.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_dividas.js'); ?>"></script>
