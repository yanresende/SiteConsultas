...
<body>
	<div class="container">
		...
		<input type="hidden" id="apiSelecionada" value="api1">
		<div class="api-selector">
			<button onclick="selecionarApi('api1')" id="btn-api1" class="api-btn active">Buscador 1</button>
			<button onclick="selecionarApi('api2')" id="btn-api2" class="api-btn ">Buscador 2</button>
			<button onclick="selecionarApi('api3')" id="btn-api3" class="api-btn">Buscador 3</button>
		</div>
