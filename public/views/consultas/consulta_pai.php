...
<head>
	...
	<title>Painel de Consulta Nome Pai</title>
...
<body>
	...
	<script src="../../assets/js/consultas/consulta_pai.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_pai.js'); ?>"></script>
