...
<head>
	...
	<title>Painel de Consulta RG</title>
...
<body>
	<div class="container">
		...
		<button id="consultarBtn" onclick="consultarRG()" disabled>Consultar</button>
	...
	<script src="../../assets/js/consultas/consulta_rg.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_rg.js'); ?>"></script>
