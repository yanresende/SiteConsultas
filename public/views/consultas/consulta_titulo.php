...
<head>
	...
	<title>Painel de Consulta Titulo</title>
...
<body>
	<div class="container">
		...
		<button id="consultarBtn" onclick="consultarTitulo()" disabled>Consultar</button>
	...
	<script src="../../assets/js/consultas/consulta_titulo.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_titulo.js'); ?>"></script>
