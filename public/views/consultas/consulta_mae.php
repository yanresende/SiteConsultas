...
<head>
	...
	<title>Painel de Consulta Nome Mãe</title>
...
<body>
	...
	<script src="../../assets/js/consultas/consulta_mae.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_mae.js'); ?>"></script>
