...
<head>
	...
	<title>Painel de Consulta Motor</title>
...
<body>
	<div class="container">
		...
		<input type="text" id="motor" placeholder="Digite o Motor" maxlength="14">
		<button id="consultarBtn" onclick="consultarMotor()" disabled>Consultar</button>
	...
	<script src="../../assets/js/consultas/consulta_motor.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_motor.js'); ?>"></script>
