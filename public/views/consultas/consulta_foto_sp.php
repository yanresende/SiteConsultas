...
<head>
	...
	<title>Painel de Consulta Foto SP</title>
...
<body>
	...
	<script src="../../assets/js/consultas/consulta_foto_sp.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_foto_sp.js'); ?>"></script>
