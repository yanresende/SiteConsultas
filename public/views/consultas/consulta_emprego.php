...
<head>
	...
	<title>Painel de Consulta Empregos</title>
...
<body>
	<div class="container">
		...
		<h2>Consulta Emprego</h2>
		<input type="text" id="emprego" placeholder="Digite o CPF" maxlength="14" oninput="formatCPF(this)">
		<button id="consultarBtn" onclick="consultarEmprego()" disabled>Consultar</button>
	...
	<script src="../../assets/js/consultas/consulta_emprego.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_emprego.js'); ?>"></script>
