...
<head>
	...
	<title>Painel de Consulta Vizinhos</title>
...
<body>
	<div class="container">
		...
		<h2>Consulta Vizinhos</h2>
		<input type="text" id="cpf" placeholder="Digite o CPF" maxlength="14" oninput="formatCPF(this)">
		<button id="consultarBtn" onclick="consultarVizinho()" disabled>Consultar</button>
	...
	<script src="../../assets/js/consultas/consulta_vizinhos.js?v=<?php echo md5_file('../../assets/js/consultas/consulta_vizinhos.js'); ?>"></script>
